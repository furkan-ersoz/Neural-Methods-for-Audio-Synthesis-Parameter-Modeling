...
class SynthV2Editor : public juce::AudioProcessorEditor,
                             public juce::FileDragAndDropTarget
{
public:
    explicit SynthV2Editor(SynthV2Processor&);
    ~SynthV2Editor() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(SynthV2Editor)
};
