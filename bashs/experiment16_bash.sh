#!/bin/bash
# experiment16_bash.sh — Exp016: FULL sequential training (door + 12 frames), 50k samples
...
#   bash bashs/experiment16_bash.sh
set -euo pipefail

ROOT="$(cd "$(dirname "$0")/.." && pwd)"
PYTHON="$(command -v python3 || true)"
EXP_DIR="$ROOT/synths/SynthV3/Experiments/Exp016"
...
echo "=============================================="
echo "  Experiment16 — FULL sequential (50k)"
echo "  Root     : $ROOT"
echo "  Python   : $PYTHON"
...
if [ -f "$EXP_DIR/logs/door/train_log.json" ]; then
    ...
    git_save "Exp016: door (classification) trained"
fi
...
for FRAME in "${FRAMES[@]}"; do
    ...
    git_save "Exp016: frame '$FRAME' trained"
done
...
git_save "Exp016: evaluation results"
...
echo "=============================================="
echo "  Experiment16 tamamlandi: $(date)"
echo "=============================================="
