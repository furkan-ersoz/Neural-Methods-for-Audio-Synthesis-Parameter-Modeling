...
# ─────────────────────────────────────────────────────────────────────────────
def run_export(cfg: dict, ckpt_path: Path, device: torch.device) -> None:
    """Core export logic — called by main() and train.py auto_export."""
...
def main():
    ...
    run_export(cfg, ckpt_path, device)
